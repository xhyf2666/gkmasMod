...
public class ENBaseAppeal extends GkmasBossCard {
    private static final String CLASSNAME = ENBaseAppeal.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENBaseAppeal.class.getSimpleName().substring(2);
