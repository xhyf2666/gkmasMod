...
public class ENJustDemon extends GkmasBossCard {
    private static final String CLASSNAME = ENJustDemon.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENJustDemon.class.getSimpleName().substring(2);
