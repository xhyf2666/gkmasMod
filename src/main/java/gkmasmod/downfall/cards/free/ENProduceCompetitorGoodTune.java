...
public class ENProduceCompetitorGoodTune extends GkmasBossCard {
    private static final String CLASSNAME = ENProduceCompetitorGoodTune.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENProduceCompetitorGoodTune.class.getSimpleName().substring(2);
    ...
    public ENProduceCompetitorGoodTune() {
    ...
    public AbstractCard makeCopy() {
        return new ENProduceCompetitorGoodTune();
    }
