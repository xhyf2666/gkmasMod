...
public class ENProduceCompetitorStrength extends GkmasBossCard {
    private static final String CLASSNAME = ENProduceCompetitorStrength.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENProduceCompetitorStrength.class.getSimpleName().substring(2);
    ...
    public ENProduceCompetitorStrength() {
    ...
    public AbstractCard makeCopy() {
        return new ENProduceCompetitorStrength();
    }
