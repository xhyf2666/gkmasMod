...
public class ENGodArrival extends GkmasBossCard {
    private static final String CLASSNAME = ENGodArrival.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENGodArrival.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new SpawnMonsterAction(new FriendOnigiri(m.hb_x+200, m.hb_y,m), true));
    }

    @Override
    public AbstractCard makeCopy() {
        return new ENGodArrival();
    }
