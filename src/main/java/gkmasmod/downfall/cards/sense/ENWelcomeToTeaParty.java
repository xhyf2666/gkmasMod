...
public class ENWelcomeToTeaParty extends GkmasBossCard {
    private static final String CLASSNAME = ENWelcomeToTeaParty.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENWelcomeToTeaParty.class.getSimpleName().substring(2);
...
//        addToBot(new DrawCardAction(1));
    ...
    public AbstractCard makeCopy() {
        return new ENWelcomeToTeaParty();
    }
