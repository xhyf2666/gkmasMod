...
public class ENGrip extends GkmasBossCard {
    private static final String CLASSNAME = ENGrip.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENGrip.class.getSimpleName().substring(2);
