...
public class ENCharmPerformance extends GkmasBossCard {
    private static final String CLASSNAME = ENCharmPerformance.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENCharmPerformance.class.getSimpleName().substring(2);
