...
public class ENCharmGaze extends GkmasBossCard {
    private static final String CLASSNAME = ENCharmGaze.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENCharmGaze.class.getSimpleName().substring(2);
