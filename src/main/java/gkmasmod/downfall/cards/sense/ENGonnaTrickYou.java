...
public class ENGonnaTrickYou extends GkmasBossCard {
    private static final String CLASSNAME = ENGonnaTrickYou.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENGonnaTrickYou.class.getSimpleName().substring(2);
