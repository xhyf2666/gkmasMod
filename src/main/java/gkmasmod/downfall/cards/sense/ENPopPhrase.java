...
public class ENPopPhrase extends GkmasBossCard {
    private static final String CLASSNAME = ENPopPhrase.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENPopPhrase.class.getSimpleName().substring(2);
