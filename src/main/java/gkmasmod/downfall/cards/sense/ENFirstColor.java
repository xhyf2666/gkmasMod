...
public class ENFirstColor extends GkmasBossCard {
    private static final String CLASSNAME = ENFirstColor.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENFirstColor.class.getSimpleName().substring(2);
