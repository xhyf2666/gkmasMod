...
public class ENLittlePrince extends GkmasBossCard {
    private static final String CLASSNAME = ENLittlePrince.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENLittlePrince.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        int amount = PlayerHelper.getPowerAmount(m, GoodTune.POWER_ID);
        if (amount > 0) {
    ...
    public AbstractCard makeCopy() {
        return (AbstractCard) new ENLittlePrince();
    }
