...
public class ENBless extends GkmasBossCard {
    private static final String CLASSNAME = ENBless.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENBless.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new BlessAction(p,new DamageInfo(m, this.damage, this.damageTypeForTurn)));
    }
