...
public class ENImprovise extends GkmasBossCard {
    private static final String CLASSNAME = ENImprovise.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENImprovise.class.getSimpleName().substring(2);
