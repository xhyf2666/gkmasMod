...
public class ENPerformancePlan extends GkmasBossCard {
    private static final String CLASSNAME = ENPerformancePlan.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENPerformancePlan.class.getSimpleName().substring(2);
