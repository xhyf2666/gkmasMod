...
public class ENLightGait extends GkmasBossCard {
    private static final String CLASSNAME = ENLightGait.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENLightGait.class.getSimpleName().substring(2);
