...
public class ENRisingStar extends GkmasBossCard {
    private static final String CLASSNAME = ENRisingStar.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENRisingStar.class.getSimpleName().substring(2);
