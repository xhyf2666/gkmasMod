...
public class ENVeryEasy extends GkmasBossCard {
    private static final String CLASSNAME = ENVeryEasy.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENVeryEasy.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m, m, new VeryEasyPower(m,this.secondMagicNumber),this.secondMagicNumber));
