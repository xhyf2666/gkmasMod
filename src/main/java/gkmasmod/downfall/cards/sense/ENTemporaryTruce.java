...
import gkmasmod.actions.special.EnemySkewerAction;
...
public class ENTemporaryTruce extends GkmasBossCard {
    private static final String CLASSNAME = ENTemporaryTruce.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENTemporaryTruce.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if(this.upgraded){
            addToBot(new EnemySkewerAction(m, p, this.damage, this.damageTypeForTurn, this.freeToPlayOnce, this.energyOnUse+1));
        }
        else{
