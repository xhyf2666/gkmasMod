...
public class ENSwayingOnTheBus extends GkmasBossCard {
    private static final String CLASSNAME = ENSwayingOnTheBus.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENSwayingOnTheBus.class.getSimpleName().substring(2);
