...
public class ENLoneWolf extends GkmasBossCard {
    private static final String CLASSNAME = ENLoneWolf.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENLoneWolf.class.getSimpleName().substring(2);
