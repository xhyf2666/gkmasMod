...
public class ENStubborn extends GkmasBossCard {
    private static final String CLASSNAME = ENStubborn.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENStubborn.class.getSimpleName().substring(2);
