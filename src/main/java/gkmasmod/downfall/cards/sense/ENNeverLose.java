...
public class ENNeverLose extends GkmasBossCard {
    private static final String CLASSNAME = ENNeverLose.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENNeverLose.class.getSimpleName().substring(2);
