...
public class ENTryError extends GkmasBossCard {
    private static final String CLASSNAME = ENTryError.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENTryError.class.getSimpleName().substring(2);
