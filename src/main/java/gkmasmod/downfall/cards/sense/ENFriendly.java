...
public class ENFriendly extends GkmasBossCard {
    private static final String CLASSNAME = ENFriendly.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENFriendly.class.getSimpleName().substring(2);
