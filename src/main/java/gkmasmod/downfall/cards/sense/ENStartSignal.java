...
public class ENStartSignal extends GkmasBossCard {
    private static final String CLASSNAME = ENStartSignal.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENStartSignal.class.getSimpleName().substring(2);
