...
public class ENFullAdrenaline extends GkmasBossCard {
    private static final String CLASSNAME = ENFullAdrenaline.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENFullAdrenaline.class.getSimpleName().substring(2);
