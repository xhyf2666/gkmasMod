...
public class ENHighFive extends GkmasBossCard {
    private static final String CLASSNAME = ENHighFive.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENHighFive.class.getSimpleName().substring(2);
