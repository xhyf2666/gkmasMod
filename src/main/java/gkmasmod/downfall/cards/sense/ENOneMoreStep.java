...
public class ENOneMoreStep extends GkmasBossCard {
    private static final String CLASSNAME = ENOneMoreStep.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENOneMoreStep.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (amount > magicNumber) {
            addToBot(new DamageAction(p, new DamageInfo(m, this.secondDamage, this.damageTypeForTurn), AbstractGameAction.AttackEffect.SLASH_DIAGONAL));
        }
