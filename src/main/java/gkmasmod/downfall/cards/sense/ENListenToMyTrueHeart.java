...
public class ENListenToMyTrueHeart extends GkmasBossCard {
    private static final String CLASSNAME = ENListenToMyTrueHeart.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENListenToMyTrueHeart.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m,m,new ListenToMyTrueHeartPower(m,count),count));
    }

    @Override
    public AbstractCard makeCopy() {
        return new ENListenToMyTrueHeart();
    }
