...
public class ENChallenge extends GkmasBossCard {
    private static final String CLASSNAME = ENChallenge.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENChallenge.class.getSimpleName().substring(2);
