...
public class ENSteadyWill extends GkmasBossCard {
    private static final String CLASSNAME = ENSteadyWill.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENSteadyWill.class.getSimpleName().substring(2);
