...
public class ENServiceSpirit extends GkmasBossCard {
    private static final String CLASSNAME = ENServiceSpirit.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENServiceSpirit.class.getSimpleName().substring(2);
