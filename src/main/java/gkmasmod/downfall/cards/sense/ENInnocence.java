...
public class ENInnocence extends GkmasBossCard {
    private static final String CLASSNAME = ENInnocence.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENInnocence.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m, m, new InnocencePower(m, 1), 1));
    }

    @Override
    public AbstractCard makeCopy() {
        return  new ENInnocence();
    }
