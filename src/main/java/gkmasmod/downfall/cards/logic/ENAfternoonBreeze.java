...
public class ENAfternoonBreeze extends GkmasBossCard {
    private static final String CLASSNAME = ENAfternoonBreeze.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENAfternoonBreeze.class.getSimpleName().substring(2);
