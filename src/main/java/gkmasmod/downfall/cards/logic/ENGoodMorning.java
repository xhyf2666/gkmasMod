...
public class ENGoodMorning extends GkmasBossCard {
    private static final String CLASSNAME = ENGoodMorning.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENGoodMorning.class.getSimpleName().substring(2);
