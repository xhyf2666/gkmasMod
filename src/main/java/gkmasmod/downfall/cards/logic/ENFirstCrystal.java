...
public class ENFirstCrystal extends GkmasBossCard {
    private static final String CLASSNAME = ENFirstCrystal.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENFirstCrystal.class.getSimpleName().substring(2);
