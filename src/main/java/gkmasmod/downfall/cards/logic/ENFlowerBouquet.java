...
public class ENFlowerBouquet extends GkmasBossCard {
    private static final String CLASSNAME = ENFlowerBouquet.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENFlowerBouquet.class.getSimpleName().substring(2);
