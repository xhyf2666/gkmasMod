...
public class ENHeartbeat extends GkmasBossCard {
    private static final String CLASSNAME = ENHeartbeat.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENHeartbeat.class.getSimpleName().substring(2);
