...
public class ENContact extends GkmasBossCard {
    private static final String CLASSNAME = ENContact.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENContact.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m,m,new Uplifting(m,this.secondMagicNumber),this.secondMagicNumber));
    }


    @Override
    public AbstractCard makeCopy() {
        return new ENContact();
    }
