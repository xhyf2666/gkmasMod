...
public class ENDebutStageForTheLady extends GkmasBossCard {
    private static final String CLASSNAME = ENDebutStageForTheLady.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENDebutStageForTheLady.class.getSimpleName().substring(2);
    ...
    public AbstractCard makeCopy() {
        return new ENDebutStageForTheLady();
    }
