...
public class ENLovesTheStruggle extends GkmasBossCard {
    private static final String CLASSNAME = ENLovesTheStruggle.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENLovesTheStruggle.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new DexterityPowerDamageAction(this.magicNumber*1.0F/100, 0,m, p, this));
