...
public class ENStarDust extends GkmasBossCard {
    private static final String CLASSNAME = ENStarDust.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENStarDust.class.getSimpleName().substring(2);
