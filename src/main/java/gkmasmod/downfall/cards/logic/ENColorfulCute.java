...
public class ENColorfulCute extends GkmasBossCard {
    private static final String CLASSNAME = ENColorfulCute.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENColorfulCute.class.getSimpleName().substring(2);
