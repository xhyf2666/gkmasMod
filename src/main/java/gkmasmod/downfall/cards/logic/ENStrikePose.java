...
public class ENStrikePose extends GkmasBossCard {
    private static final String CLASSNAME = ENStrikePose.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENStrikePose.class.getSimpleName().substring(2);
