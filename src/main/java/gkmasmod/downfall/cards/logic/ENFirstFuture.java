...
public class ENFirstFuture extends GkmasBossCard {
    private static final String CLASSNAME = ENFirstFuture.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENFirstFuture.class.getSimpleName().substring(2);
