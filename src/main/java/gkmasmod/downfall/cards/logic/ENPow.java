...
public class ENPow extends GkmasBossCard {
    private static final String CLASSNAME = ENPow.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENPow.class.getSimpleName().substring(2);
