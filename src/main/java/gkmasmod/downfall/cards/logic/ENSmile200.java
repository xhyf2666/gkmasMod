...
public class ENSmile200 extends GkmasBossCard {
    private static final String CLASSNAME = ENSmile200.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENSmile200.class.getSimpleName().substring(2);
