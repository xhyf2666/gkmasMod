...
public class ENMoonlitRunway extends GkmasBossCard {
    private static final String CLASSNAME = ENMoonlitRunway.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENMoonlitRunway.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(this.upgraded){
            addToBot(new ApplyPowerAction(m, m, new MoonlitRunwayPlusPower(m, 1), 1));
        }
        else{
            addToBot(new ApplyPowerAction(m, m, new MoonlitRunwayPower(m, 1), 1));
        }
