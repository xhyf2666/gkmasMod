...
public class ENNotebookDetermination extends GkmasBossCard {
    private static final String CLASSNAME = ENNotebookDetermination.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENNotebookDetermination.class.getSimpleName().substring(2);
    ...
    public ENNotebookDetermination() {
    ...
    public AbstractCard makeCopy() {
        return new ENNotebookDetermination();
    }
