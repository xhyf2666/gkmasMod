...
public class ENThankYou extends GkmasBossCard {
    private static final String CLASSNAME = ENThankYou.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENThankYou.class.getSimpleName().substring(2);
