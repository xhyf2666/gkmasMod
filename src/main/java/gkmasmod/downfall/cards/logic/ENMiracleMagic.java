...
public class ENMiracleMagic extends GkmasBossCard {
    private static final String CLASSNAME = ENMiracleMagic.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENMiracleMagic.class.getSimpleName().substring(2);
