...
public class ENOverflowMemory extends GkmasBossCard {
    private static final String CLASSNAME = ENOverflowMemory.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENOverflowMemory.class.getSimpleName().substring(2);
