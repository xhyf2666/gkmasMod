...
public class ENWakuWaku extends GkmasBossCard {
    private static final String CLASSNAME = ENWakuWaku.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENWakuWaku.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m, m, new WakuWakuPower(m, 1), 1));
    }

    @Override
    public AbstractCard makeCopy() {
        return new ENWakuWaku();
    }
