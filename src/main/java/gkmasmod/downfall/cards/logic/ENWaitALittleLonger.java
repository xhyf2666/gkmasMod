...
public class ENWaitALittleLonger extends GkmasBossCard {
    private static final String CLASSNAME = ENWaitALittleLonger.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENWaitALittleLonger.class.getSimpleName().substring(2);
    ...
    public AbstractCard makeCopy() {
        return  new ENWaitALittleLonger();
    }
