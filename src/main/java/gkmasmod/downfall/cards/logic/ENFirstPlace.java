...
public class ENFirstPlace extends GkmasBossCard {
    private static final String CLASSNAME = ENFirstPlace.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENFirstPlace.class.getSimpleName().substring(2);
