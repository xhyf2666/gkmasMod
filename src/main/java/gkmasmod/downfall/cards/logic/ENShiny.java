...
public class ENShiny extends GkmasBossCard {
    private static final String CLASSNAME = ENShiny.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENShiny.class.getSimpleName().substring(2);
