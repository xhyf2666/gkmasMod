...
public class ENForShiningYou extends GkmasBossCard {
    private static final String CLASSNAME = ENForShiningYou.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENForShiningYou.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(this.upgraded){
            addToBot(new ApplyPowerAction(m, m, new ForShiningYouPlusPower(m, 1), 1));
        }
        else{
            addToBot(new ApplyPowerAction(m, m, new ForShiningYouPower(m, 1), 1));
        }
