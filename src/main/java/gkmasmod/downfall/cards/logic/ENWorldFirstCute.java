...
public class ENWorldFirstCute extends GkmasBossCard {
    private static final String CLASSNAME = ENWorldFirstCute.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENWorldFirstCute.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m,m,new KawaiiPower(m,count),count));
    }

    @Override
    public AbstractCard makeCopy() {
        return new ENWorldFirstCute();
    }
