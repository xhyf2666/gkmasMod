...
public class ENFlowering extends GkmasBossCard {
    private static final String CLASSNAME = ENFlowering.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENFlowering.class.getSimpleName().substring(2);
