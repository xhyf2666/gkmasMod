...
public class ENClearUp extends GkmasBossCard {
    private static final String CLASSNAME = ENClearUp.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENClearUp.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new SpecialBlockDamageAction(1.0f*this.magicNumber/100,0,m,p,this));
    }

    @Override
    public AbstractCard makeCopy() {
        return  new ENClearUp();
    }
