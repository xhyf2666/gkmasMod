...
public class ENArbeiter extends GkmasBossCard {
    private static final String CLASSNAME = ENArbeiter.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENArbeiter.class.getSimpleName().substring(2);
