...
public class ENHandwrittenLetter extends GkmasBossCard {
    private static final String CLASSNAME = ENHandwrittenLetter.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENHandwrittenLetter.class.getSimpleName().substring(2);
    ...
    public AbstractCard makeCopy() {
        return new ENHandwrittenLetter();
    }
