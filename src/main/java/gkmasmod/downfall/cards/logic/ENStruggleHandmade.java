...
public class ENStruggleHandmade extends GkmasBossCard {
    private static final String CLASSNAME = ENStruggleHandmade.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENStruggleHandmade.class.getSimpleName().substring(2);
