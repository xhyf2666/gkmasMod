...
public class ENSeriousHobby extends GkmasBossCard {
    private static final String CLASSNAME = ENSeriousHobby.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENSeriousHobby.class.getSimpleName().substring(2);
    ...
    private static final int BLOCK_AMT2 = 4;
    private static final int UPGRADE_PLUS_BLOCK2 = 3;
