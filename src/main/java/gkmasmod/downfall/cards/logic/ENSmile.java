...
public class ENSmile extends GkmasBossCard {
    private static final String CLASSNAME = ENSmile.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENSmile.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (count > secondMagicNumber) {
            addToBot(new ApplyPowerAction(m, m, new DexterityPower(m, thirdMagicNumber), thirdMagicNumber));
        }
