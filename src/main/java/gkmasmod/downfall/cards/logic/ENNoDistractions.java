...
public class ENNoDistractions extends GkmasBossCard {
    private static final String CLASSNAME = ENNoDistractions.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENNoDistractions.class.getSimpleName().substring(2);
