...
public class ENSunbathing extends GkmasBossCard {
    private static final String CLASSNAME = ENSunbathing.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENSunbathing.class.getSimpleName().substring(2);
