...
public class ENHappy extends GkmasBossCard {
    private static final String CLASSNAME = ENHappy.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENHappy.class.getSimpleName().substring(2);
