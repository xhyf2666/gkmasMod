...
public class ENFreeWoman extends GkmasBossCard {
    private static final String CLASSNAME = ENFreeWoman.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENFreeWoman.class.getSimpleName().substring(2);
