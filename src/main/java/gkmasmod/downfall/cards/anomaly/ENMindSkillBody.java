...
public class ENMindSkillBody extends GkmasBossCard {
    private static final String CLASSNAME = ENMindSkillBody.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENMindSkillBody.class.getSimpleName().substring(2);
    ...
    private static final int UPGRADE_DAMAGE_PLUS = 5;
