...
public class ENRestAndWalk extends GkmasBossCard {
    private static final String CLASSNAME = ENRestAndWalk.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENRestAndWalk.class.getSimpleName().substring(2);
