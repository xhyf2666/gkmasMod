...
public class ENIntensely extends GkmasBossCard {
    private static final String CLASSNAME = ENIntensely.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENIntensely.class.getSimpleName().substring(2);
