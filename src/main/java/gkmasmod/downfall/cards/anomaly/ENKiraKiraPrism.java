...
public class ENKiraKiraPrism extends GkmasBossCard {
    private static final String CLASSNAME = ENKiraKiraPrism.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENKiraKiraPrism.class.getSimpleName().substring(2);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m,m,new KiraKiraPrismPower(m,this.magicNumber),this.magicNumber));
        SoundHelper.playSound("gkmasModResource/audio/voice/skillcard/cidol_kllj_3_001_produce_skillcard_01.ogg");
    }

    @Override
    public AbstractCard makeCopy() {
        return new ENKiraKiraPrism();
    }
