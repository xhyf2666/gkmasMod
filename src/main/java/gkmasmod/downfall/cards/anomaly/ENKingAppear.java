...
public class ENKingAppear extends GkmasBossCard {
    private static final String CLASSNAME = ENKingAppear.class.getSimpleName();
    public static final String ID = NameHelper.makePath(CLASSNAME);
    private static final String CLASSNAME2 = ENKingAppear.class.getSimpleName().substring(2);
