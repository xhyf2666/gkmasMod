...
import gkmasmod.relics.LastSummerMemory;

public class CBR_LastSummerMemory extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_LastSummerMemory.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_LastSummerMemory.class.getSimpleName().substring(4);
    ...
    public CBR_LastSummerMemory() {
        super(new LastSummerMemory(),IMG);    }
    ...
    public AbstractRelic makeCopy() {
        return (AbstractRelic)new CBR_LastSummerMemory();
    }
