...
import gkmasmod.downfall.cards.logic.ENTeaChat;
...
import gkmasmod.relics.DreamOfTheDescription;

public class CBR_DreamOfTheDescription extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_DreamOfTheDescription.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_DreamOfTheDescription.class.getSimpleName().substring(4);
    ...
    public CBR_DreamOfTheDescription() {
        super(new DreamOfTheDescription(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_DreamOfTheDescription();
    }
    ...
    public void onUseCard(AbstractCard card, UseCardAction useCardAction){
        if (card.cardID.equals(ENTeaChat.ID)) {
            if (this.counter > 0) {
