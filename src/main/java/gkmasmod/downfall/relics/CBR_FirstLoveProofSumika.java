...
public class CBR_FirstLoveProofSumika extends AbstractCharbossRelic {
    ...
    private static final String CLASSNAME = CBR_FirstLoveProofSumika.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_FirstLoveProofSumika.class.getSimpleName().substring(4);
    ...
    private static final int BASE_MAGIC = 180;

    private static final int YARUKI = 7;
    private float magicNumber;
    private static int playTimes = 2;

    public CBR_FirstLoveProofSumika() {
        super(new FirstLoveProofSumika(),IMG);
    ...
    public AbstractRelic makeCopy() {
        return new CBR_FirstLoveProofSumika();
    }
