...
import gkmasmod.relics.InnerLightEarrings;

public class CBR_InnerLightEarrings extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_InnerLightEarrings.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_InnerLightEarrings.class.getSimpleName().substring(4);
    ...
    public CBR_InnerLightEarrings() {
        super(new InnerLightEarrings(),IMG);    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_InnerLightEarrings();
    }
