...
import gkmasmod.relics.WinningDetermination;

public class CBR_WinningDetermination extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_WinningDetermination.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_WinningDetermination.class.getSimpleName().substring(4);
    ...
    public CBR_WinningDetermination() {
        super(new WinningDetermination(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_WinningDetermination();
    }
