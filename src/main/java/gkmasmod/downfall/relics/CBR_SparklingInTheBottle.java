...
import gkmasmod.relics.SparklingInTheBottle;

public class CBR_SparklingInTheBottle extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_SparklingInTheBottle.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_SparklingInTheBottle.class.getSimpleName().substring(4);
    ...
    public CBR_SparklingInTheBottle() {
        super(new SparklingInTheBottle(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_SparklingInTheBottle();
    }
