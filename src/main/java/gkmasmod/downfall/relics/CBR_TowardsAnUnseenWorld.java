...
import gkmasmod.relics.TowardsAnUnseenWorld;

public class CBR_TowardsAnUnseenWorld extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_TowardsAnUnseenWorld.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_TowardsAnUnseenWorld.class.getSimpleName().substring(4);
    ...
    public CBR_TowardsAnUnseenWorld() {
        super(new TowardsAnUnseenWorld(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_TowardsAnUnseenWorld();
    }
