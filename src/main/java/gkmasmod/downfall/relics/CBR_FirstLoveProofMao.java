...
import gkmasmod.relics.FirstLoveProofMao;

public class CBR_FirstLoveProofMao extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_FirstLoveProofMao.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_FirstLoveProofMao.class.getSimpleName().substring(4);
    ...
    public CBR_FirstLoveProofMao() {
        super(new FirstLoveProofMao(),IMG);    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_FirstLoveProofMao();
    }
