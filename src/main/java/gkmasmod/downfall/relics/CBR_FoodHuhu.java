...
public class CBR_FoodHuhu extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_FoodHuhu.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_FoodHuhu.class.getSimpleName().substring(4);
