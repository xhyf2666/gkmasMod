...
import gkmasmod.relics.TechnoDog;

public class CBR_TechnoDog extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_TechnoDog.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_TechnoDog.class.getSimpleName().substring(4);
    ...
    public CBR_TechnoDog() {
        super(new TechnoDog(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return (AbstractRelic)new CBR_TechnoDog();
    }
