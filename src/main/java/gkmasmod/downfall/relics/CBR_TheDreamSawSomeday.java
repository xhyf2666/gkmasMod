...
import gkmasmod.downfall.cards.sense.ENWarmUp;
import gkmasmod.downfall.charbosses.bosses.AbstractCharBoss;
import gkmasmod.downfall.charbosses.relics.AbstractCharbossRelic;
import gkmasmod.powers.TheDreamSawSomedayPower;
import gkmasmod.relics.BeginnerGuideForEveryone;
import gkmasmod.relics.TheDreamSawSomeday;

public class CBR_TheDreamSawSomeday extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_TheDreamSawSomeday.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_TheDreamSawSomeday.class.getSimpleName().substring(4);
    ...
    public CBR_TheDreamSawSomeday() {
        super(new TheDreamSawSomeday(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_TheDreamSawSomeday();
    }
    ...
    public void onUseCard(AbstractCard card, UseCardAction useCardAction){
        if (card.cardID.equals(ENWarmUp.ID)) {
            if (this.counter > 0) {
                ...
                addToBot(new ApplyPowerAction(AbstractCharBoss.boss, AbstractCharBoss.boss, new TheDreamSawSomedayPower(AbstractCharBoss.boss, this.magicNumber2), this.magicNumber2));
                this.counter--;
                if (this.counter == 0) {
                    this.grayscale = true;
                }
