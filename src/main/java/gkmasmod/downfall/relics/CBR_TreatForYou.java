...
import gkmasmod.relics.TreatForYou;

public class CBR_TreatForYou extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_TreatForYou.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_TreatForYou.class.getSimpleName().substring(4);
    ...
    public CBR_TreatForYou() {
        super(new TreatForYou(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return (AbstractRelic)new CBR_TreatForYou();
    }
