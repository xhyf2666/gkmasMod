...
import gkmasmod.relics.YouFindMe;

public class CBR_YouFindMe extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_YouFindMe.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_YouFindMe.class.getSimpleName().substring(4);
    ...
    public CBR_YouFindMe() {
        super(new YouFindMe(),IMG);
    }
    ...
    public void onUseCard(AbstractCard card, UseCardAction useCardAction){
        if (card.cardID.equals(ENSurpriseMiss.ID)) {
            if (this.counter > 0) {
                ...
                addToBot(new ApplyPowerAction(AbstractCharBoss.boss, AbstractCharBoss.boss, new YouFindMePower(AbstractCharBoss.boss, magicNumber2), magicNumber2));
                this.counter--;
                if (this.counter == 0) {
                    this.grayscale = true;
                }
