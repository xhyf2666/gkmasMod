...
import gkmasmod.relics.FirstStarKeychain;
import gkmasmod.utils.PlayerHelper;

public class CBR_FirstStarKeychain extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_FirstStarKeychain.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_FirstStarKeychain.class.getSimpleName().substring(4);
    ...
    public CBR_FirstStarKeychain() {
        super(new FirstStarKeychain(),IMG);    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_FirstStarKeychain();
    }
    ...
    public void atTurnStart() {
        if (this.counter > 0) {
            int count = PlayerHelper.getPowerAmount(AbstractCharBoss.boss, GoodImpression.POWER_ID);
            if(count>REQUIRE){
