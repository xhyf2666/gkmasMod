...
import gkmasmod.relics.ArcadeLoot;

public class CBR_ArcadeLoot extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_ArcadeLoot.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_ArcadeLoot.class.getSimpleName().substring(4);
    ...
    public CBR_ArcadeLoot() {
        super(new ArcadeLoot(),IMG);
    }
