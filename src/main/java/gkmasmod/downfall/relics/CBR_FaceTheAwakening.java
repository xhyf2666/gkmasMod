...
public class CBR_FaceTheAwakening extends AbstractCharbossRelic {
    ...
    private static final String CLASSNAME = CBR_FaceTheAwakening.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_FaceTheAwakening.class.getSimpleName().substring(4);
    ...
    public CBR_FaceTheAwakening() {
        super(new FaceTheAwakening(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_FaceTheAwakening();
    }
    ...
    public void onUseCard(AbstractCard card, UseCardAction useCardAction){
        if (card.cardID.equals(ENLightGait.ID)) {
            if (this.counter > 0) {
                ...
                addToBot(new GainTrainRoundPowerAction(AbstractCharBoss.boss, magicNumber2));
                this.counter--;
                if (this.counter == 0) {
                    this.grayscale = true;
                }
