...
import gkmasmod.relics.FoodIris;

public class CBR_FoodIris extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_FoodIris.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_FoodIris.class.getSimpleName().substring(4);
    ...
    public void onEquip() {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this.owner,this.owner,new PoisonPower(this.owner,this.owner,magicNumber),magicNumber));
