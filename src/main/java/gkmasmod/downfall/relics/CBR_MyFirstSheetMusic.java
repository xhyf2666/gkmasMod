...
import gkmasmod.relics.MyFirstSheetMusic;

public class CBR_MyFirstSheetMusic extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_MyFirstSheetMusic.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_MyFirstSheetMusic.class.getSimpleName().substring(4);
    ...
    public CBR_MyFirstSheetMusic() {
        super(new MyFirstSheetMusic(),IMG);    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_MyFirstSheetMusic();
    }
