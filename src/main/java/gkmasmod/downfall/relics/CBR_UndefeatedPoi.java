...
import gkmasmod.relics.UndefeatedPoi;

public class CBR_UndefeatedPoi extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_UndefeatedPoi.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_UndefeatedPoi.class.getSimpleName().substring(4);
    ...
    public CBR_UndefeatedPoi() {
        super(new UndefeatedPoi(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return (AbstractRelic)new CBR_UndefeatedPoi();
    }
    ...
    public void atTurnStartPostDraw() {
        if (this.counter > 0) {
            ...
            if(count>GOOD_IMPRESSION){
                ...
                this.flash();
                addToBot(new HealAction(AbstractCharBoss.boss, AbstractCharBoss.boss, magicNumber));
                this.counter--;
                if (this.counter == 0) {
                    this.grayscale = true;
                }
