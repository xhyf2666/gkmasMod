...
import gkmasmod.relics.SidewalkResearchNotes;

public class CBR_SidewalkResearchNotes extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_SidewalkResearchNotes.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_SidewalkResearchNotes.class.getSimpleName().substring(4);
    ...
    public CBR_SidewalkResearchNotes() {
        super(new SidewalkResearchNotes(),IMG);
    ...
    public AbstractRelic makeCopy() {
        return new CBR_SidewalkResearchNotes();
    }
