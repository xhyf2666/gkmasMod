...
import gkmasmod.relics.TogetherInBattleTowel;

public class CBR_TogetherInBattleTowel extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_TogetherInBattleTowel.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_TogetherInBattleTowel.class.getSimpleName().substring(4);
    ...
    public CBR_TogetherInBattleTowel() {
        super(new TogetherInBattleTowel(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_TogetherInBattleTowel();
    }
