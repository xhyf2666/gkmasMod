...
import gkmasmod.relics.FirstStarTshirt;
import gkmasmod.utils.PlayerHelper;

public class CBR_FirstStarTshirt extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_FirstStarTshirt.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_FirstStarTshirt.class.getSimpleName().substring(4);
    ...
    public CBR_FirstStarTshirt() {
        super(new FirstStarTshirt(),IMG);    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_FirstStarTshirt();
    }
