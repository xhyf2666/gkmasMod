...
public class CBR_ThisIsMe extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_ThisIsMe.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_ThisIsMe.class.getSimpleName().substring(4);
    ...
    public AbstractRelic makeCopy() {
        return (AbstractRelic)new CBR_ThisIsMe();
    }
    ...
    public void onPlayerEndTurn() {
        if (this.counter > 0) {
            ...
            if(count>GOOD_IMPRESSION){
                ...
                this.flash();
                addToBot(new ModifyDamageAction(AbstractDungeon.player,new DamageInfo(AbstractCharBoss.boss, damage, DamageInfo.DamageType.THORNS), AbstractGameAction.AttackEffect.SLASH_HORIZONTAL));
