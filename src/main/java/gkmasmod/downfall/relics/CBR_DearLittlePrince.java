...
import gkmasmod.relics.DearLittlePrince;

public class CBR_DearLittlePrince extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_DearLittlePrince.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_DearLittlePrince.class.getSimpleName().substring(4);
    ...
    public CBR_DearLittlePrince() {
        super(new DearLittlePrince(),IMG);    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_DearLittlePrince();
    }
