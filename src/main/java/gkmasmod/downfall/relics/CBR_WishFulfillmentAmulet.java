...
public class CBR_WishFulfillmentAmulet extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_WishFulfillmentAmulet.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_WishFulfillmentAmulet.class.getSimpleName().substring(4);
    ...
    public CBR_WishFulfillmentAmulet() {
        super(new WishFulfillmentAmulet(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_WishFulfillmentAmulet();
    }
