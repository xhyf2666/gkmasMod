...
import gkmasmod.relics.UnofficialMascot;
import gkmasmod.utils.PlayerHelper;

public class CBR_UnofficialMascot extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_UnofficialMascot.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_UnofficialMascot.class.getSimpleName().substring(4);
    ...
    public CBR_UnofficialMascot() {
        super(new UnofficialMascot(),IMG);
    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_UnofficialMascot();
    }
