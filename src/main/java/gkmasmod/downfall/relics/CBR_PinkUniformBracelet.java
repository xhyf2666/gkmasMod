...
import gkmasmod.relics.PinkUniformBracelet;

public class CBR_PinkUniformBracelet extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_PinkUniformBracelet.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_PinkUniformBracelet.class.getSimpleName().substring(4);
    ...
    public CBR_PinkUniformBracelet() {
        super(new PinkUniformBracelet(),IMG);    }
    ...
    public AbstractRelic makeCopy() {
        return new CBR_PinkUniformBracelet();
    }
