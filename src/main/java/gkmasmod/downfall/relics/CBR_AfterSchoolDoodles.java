...
public class CBR_AfterSchoolDoodles extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_AfterSchoolDoodles.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_AfterSchoolDoodles.class.getSimpleName().substring(4);
    ...
    public CBR_AfterSchoolDoodles() {
        super(new AfterSchoolDoodles(),IMG);
    }
