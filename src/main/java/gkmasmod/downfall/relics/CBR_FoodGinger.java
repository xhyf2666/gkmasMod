...
import gkmasmod.relics.FoodGinger;
import gkmasmod.stances.ConcentrationStance;

public class CBR_FoodGinger extends AbstractCharbossRelic {

    private static final String CLASSNAME = CBR_FoodGinger.class.getSimpleName();

    public static final String ID = CLASSNAME;

    private static final String CLASSNAME2 = CBR_FoodGinger.class.getSimpleName().substring(4);
    ...
    public CBR_FoodGinger() {
        super(new FoodGinger(),IMG);
    }
    ...
    public void onEquip() {
        ...
        AbstractDungeon.actionManager.addToBottom(new EnemyChangeStanceAction(ENConcentrationStance.STANCE_ID));
