...
import gkmasmod.downfall.charbosses.vfx.EnemyStanceChangeParticleGenerator;
import gkmasmod.downfall.charbosses.vfx.EnemyWrathParticleEffect;

public class ENConcentrationStance extends AbstractEnemyStance {
    ...
    public ENConcentrationStance() {
        this(0);
    }

    public ENConcentrationStance(int stage) {
        this.stage = stage;
        if(this.stage>1)
            this.stage = 1;
        this.ID = STANCE_ID;
    ...
    public void onPlayCard(AbstractCard card) {
        if(this.stage==1){
            AbstractDungeon.actionManager.addToBottom(new LoseHPAction(AbstractCharBoss.boss, AbstractCharBoss.boss, 1));
        }
    }
