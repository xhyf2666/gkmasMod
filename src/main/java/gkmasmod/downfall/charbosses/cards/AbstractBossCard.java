package gkmasmod.downfall.charbosses.cards;
...
import gkmasmod.downfall.charbosses.TextureLoader;
import gkmasmod.downfall.charbosses.bosses.AbstractCharBoss;
import gkmasmod.downfall.charbosses.cards.colorless.EnHandOfGreedHermitNecro;

import gkmasmod.downfall.charbosses.cards.purple.AbstractStanceChangeCard;
import gkmasmod.downfall.charbosses.cards.purple.EnCarveReality;
import gkmasmod.downfall.charbosses.cards.purple.EnSmite;
import gkmasmod.downfall.charbosses.orbs.AbstractEnemyOrb;
import gkmasmod.downfall.charbosses.powers.cardpowers.EnemyStormPower;
...
import gkmasmod.downfall.charbosses.stances.EnDivinityStance;
...
import static gkmasmod.downfall.charbosses.cards.blue.EnZap.getFocusAmountSafe;
...
public abstract class AbstractBossCard extends AbstractCard {
    ...
    public int autoPriority() {
        ...
        if (this.type == CardType.ATTACK) {
            ...
            if (ownerBoss.stance instanceof EnDivinityStance) {
    ...
    public void applyPowers() {
        ...
        for(AbstractCardModifier mod: CardModifierManager.modifiers(this)){
            tmp = mod.modifyDamage(tmp, this.damageTypeForTurn, this,AbstractCharBoss.boss);
        }
