...
public class StaminaExplosionDrink extends CustomPotion {
    private static final String CLASSNAME = StaminaExplosionDrink.class.getSimpleName();
    ...
    public AbstractPotion makeCopy() {
        return new StaminaExplosionDrink();
    }
