...
import gkmasmod.powers.SelectFirstStarTeaPower;
import gkmasmod.utils.NameHelper;

import java.util.Iterator;

public class SelectFirstStarChai extends CustomPotion {
    private static final String CLASSNAME = SelectFirstStarChai.class.getSimpleName();
    ...
    public void use(AbstractCreature target) {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new SelectFirstStarChaiPower(AbstractDungeon.player, amount), amount));
    }
    ...
    public AbstractPotion makeCopy() {
        return new SelectFirstStarChai();
    }
