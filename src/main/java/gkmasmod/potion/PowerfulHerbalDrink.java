...
import gkmasmod.actions.common.GetIdolCardInHandAction;
import gkmasmod.powers.HalfDamageReceive;
import gkmasmod.utils.NameHelper;

import java.util.Iterator;

public class PowerfulHerbalDrink extends CustomPotion {
    private static final String CLASSNAME = PowerfulHerbalDrink.class.getSimpleName();
    ...
    public void use(AbstractCreature target) {
        ...
        addToBot(new GetIdolCardInHandAction());
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new HalfDamageReceive(AbstractDungeon.player, amount), amount));
    }
    ...
    public AbstractPotion makeCopy() {
        return new PowerfulHerbalDrink();
    }
