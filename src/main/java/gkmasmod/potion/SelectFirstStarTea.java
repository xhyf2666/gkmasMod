...
public class SelectFirstStarTea extends CustomPotion {
    private static final String CLASSNAME = SelectFirstStarTea.class.getSimpleName();
    ...
    public void use(AbstractCreature target) {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new SelectFirstStarTeaPower(AbstractDungeon.player, amount), amount));
    }
