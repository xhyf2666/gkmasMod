...
public class SpecialFirstStarExtract extends CustomPotion {
    private static final String CLASSNAME = SpecialFirstStarExtract.class.getSimpleName();
    ...
    public SpecialFirstStarExtract() {
    ...
    public AbstractPotion makeCopy() {
        return new SpecialFirstStarExtract();
    }
