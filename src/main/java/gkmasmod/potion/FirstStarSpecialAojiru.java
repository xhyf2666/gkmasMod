...
import gkmasmod.actions.special.AojiruAction;
import gkmasmod.utils.NameHelper;

import java.util.Iterator;

public class FirstStarSpecialAojiru extends CustomPotion {
    private static final String CLASSNAME = FirstStarSpecialAojiru.class.getSimpleName();
    ...
    public AbstractPotion makeCopy() {
        return new FirstStarSpecialAojiru();
    }
