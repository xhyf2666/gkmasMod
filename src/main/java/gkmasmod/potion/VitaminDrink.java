...
public class VitaminDrink extends CustomPotion {
    private static final String CLASSNAME = VitaminDrink.class.getSimpleName();
    ...
    public void use(AbstractCreature target) {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new GoodTune(AbstractDungeon.player, amount), amount));
    }
