...
public class RooibosTea extends CustomPotion {
    private static final String CLASSNAME = RooibosTea.class.getSimpleName();
    ...
    public void use(AbstractCreature target) {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new GoodImpression(AbstractDungeon.player, amount), amount));
    }
