...
public class SelectFirstStarBlend extends CustomPotion {
    private static final String CLASSNAME = SelectFirstStarBlend.class.getSimpleName();
    ...
    public void use(AbstractCreature target) {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new SelectFirstStarBlendPower(AbstractDungeon.player, amount), amount));
    }
    ...
    public AbstractPotion makeCopy() {
        return new SelectFirstStarBlend();
    }
