...
public class SelectFirstStarMacchiato extends CustomPotion {
    private static final String CLASSNAME = SelectFirstStarMacchiato.class.getSimpleName();
    ...
    public SelectFirstStarMacchiato() {
    ...
    public void use(AbstractCreature target) {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new SelectFirstStarMacchiatoPower(AbstractDungeon.player, amount), amount));
    }
    ...
    public AbstractPotion makeCopy() {
        return new SelectFirstStarMacchiato();
    }
