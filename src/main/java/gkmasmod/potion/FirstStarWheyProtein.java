...
import gkmasmod.powers.AddDamageReceive;
import gkmasmod.powers.GreatGoodTune;
import gkmasmod.utils.NameHelper;

import java.util.Iterator;

public class FirstStarWheyProtein extends CustomPotion {
    private static final String CLASSNAME = FirstStarWheyProtein.class.getSimpleName();
    ...
    public AbstractPotion makeCopy() {
        return new FirstStarWheyProtein();
    }
