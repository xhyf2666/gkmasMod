...
public class HotGreenTea extends CustomPotion {
    private static final String CLASSNAME = HotGreenTea.class.getSimpleName();
    ...
    public void use(AbstractCreature target) {
        ...
        addToBot(new ChangeStanceAction(PreservationStance.STANCE_ID2));
        addToBot(new BattlePracticeAction(amount));
    }
