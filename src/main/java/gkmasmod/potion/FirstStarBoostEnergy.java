...
public class FirstStarBoostEnergy extends CustomPotion {
    private static final String CLASSNAME = FirstStarBoostEnergy.class.getSimpleName();
    ...
    public AbstractPotion makeCopy() {
        return new FirstStarBoostEnergy();
    }
