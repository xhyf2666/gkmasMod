...
public class SelectFirstStarMilkTea extends CustomPotion {
    private static final String CLASSNAME = SelectFirstStarMilkTea.class.getSimpleName();
    ...
    public AbstractPotion makeCopy() {
        return new SelectFirstStarMilkTea();
    }
