...
public class FirstStarSpecialSPAojiru extends CustomPotion {
    private static final String CLASSNAME = FirstStarSpecialSPAojiru.class.getSimpleName();
    ...
    public FirstStarSpecialSPAojiru() {
    ...
    public void use(AbstractCreature target) {
        ...
        if (AbstractDungeon.player != null && AbstractDungeon.player.hasRelic("SacredBark")) {
            addToBot(new GashaAction(AbstractDungeon.player,true,"color",true));
        }
        addToBot(new GashaAction(AbstractDungeon.player,true,"color",true));
    }
    ...
    public AbstractPotion makeCopy() {
        return new FirstStarSpecialSPAojiru();
    }
