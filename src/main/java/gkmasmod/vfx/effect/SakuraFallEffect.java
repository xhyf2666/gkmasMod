...
public class SakuraFallEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    private float vX;
    ...
    public SakuraFallEffect() {
        this.x = MathUtils.random(100.0F * Settings.scale, 1820.0F * Settings.scale);
        this.y = (float)Settings.HEIGHT - MathUtils.random(0.0F, 30.0F) * Settings.scale;
