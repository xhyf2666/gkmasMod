...
public class ThreeSizeChangeEffect extends AbstractGameEffect {
    ...
    // 构造函数
    public ThreeSizeChangeEffect(int type,int startValue, int targetValue, float x, float y, float duration) {
    ...
    public ThreeSizeChangeEffect(int type,int startValue, int targetValue, float x, float y, float duration,float delayTime){
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.img, this.x-45, this.y+10, (float)this.img.getWidth() / 2.0F, (float)this.img.getHeight() / 2.0F, (float)this.img.getWidth(), (float)this.img.getHeight(), this.scale, this.scale, this.rotation, 0, 0, this.img.getWidth(), this.img.getHeight(), false, false);
    }
