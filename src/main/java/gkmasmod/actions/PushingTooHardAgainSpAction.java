...
public class PushingTooHardAgainSpAction extends AbstractGameAction {
    private DamageInfo info;

    public PushingTooHardAgainSpAction(AbstractCreature target, DamageInfo info) {
        this.info = info;
        ...
        if (this.shouldCancelAction()) {
            ...
            if (this.isDone) {
                ...
                if (this.target.lastDamageTaken > 0) {
                    ...
                    count = (int) (count*0.15F);
                    this.addToTop(new ApplyPowerAction(this.source,this.source,new Uplifting(this.source,count),count));
