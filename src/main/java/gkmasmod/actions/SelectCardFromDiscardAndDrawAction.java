...
public class SelectCardFromDiscardAndDrawAction extends AbstractGameAction {
    public static final String[] TEXT;
    private AbstractPlayer player;
    private int numberOfCards;
    private boolean optional;

    public SelectCardFromDiscardAndDrawAction(int numberOfCards) {
    ...
    public void update() {
        if (this.duration == this.startDuration) {
            if (this.numberOfCards > 0) {
                ...
                if(temp.size()<this.numberOfCards){
    ...
    static {
        TEXT = CardCrawlGame.languagePack.getUIString("gkmasMod:SelectCardFromDiscardAndDrawAction").TEXT;
    }
}
