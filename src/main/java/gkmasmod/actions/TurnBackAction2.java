...
public class TurnBackAction2 extends AbstractGameAction {
        ...
        if (this.duration == Settings.ACTION_DUR_MED) {
            ...
            if (!AbstractDungeon.handCardSelectScreen.wereCardsRetrieved&&this.handCardSelected==null) {
                ...
                if(p.drawPile.size() == 1){
                    AbstractCard abstractCard = this.p.drawPile.getTopCard();
                    ...
                    this.p.drawPile.removeCard(abstractCard);
                    abstractCard.unhover();
                    abstractCard.fadingOut = false;
                    this.p.hand.moveToDeck(this.handCardSelected,true);
                    this.isDone = true;
                }
                else{
                    AbstractDungeon.gridSelectScreen.open(p.drawPile, 1, TEXT[1], false);
                    tickDuration();
                }
            }
        }
