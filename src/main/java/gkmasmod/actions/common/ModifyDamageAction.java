...
import gkmasmod.cards.sense.WorldFirstCourage;
...
public class ModifyDamageAction extends AbstractGameAction {
    ...
    public void update() {
        ...
        if(card instanceof WorldFirstCourage){
            addToBot(new RemoveSpecificPowerAction(AbstractDungeon.player,AbstractDungeon.player, GoodTune.POWER_ID));
        }
        this.isDone = true;
    }
