...
public class LikeYouVeryMuchAction extends AbstractGameAction {
    ...
    public LikeYouVeryMuchAction() {
        this.actionType = ActionType.CARD_MANIPULATION;
        this.duration = Settings.ACTION_DUR_FAST;
        this.amount = 1;
    }

    public LikeYouVeryMuchAction(int showCardCount) {
        this.actionType = ActionType.CARD_MANIPULATION;
        this.duration = Settings.ACTION_DUR_FAST;
        ...
        while (true) {
            ...
            if (card.hasTag(GkmasCardTag.IDOL_CARD_TAG)&&card.color.equals(color) &&card.rarity != AbstractCard.CardRarity.CURSE) {
                if(card instanceof GkmasCard){
                    ...
                    if(gkmasCard.backGroundColor.equals(IdolData.kcna)||gkmasCard.backGroundColor.equals(IdolData.shro))
                        tmpPool.add(card);
                }
            }
