...
public class ShowCardToDiscardEffect extends AbstractGameEffect {
    private static final float EFFECT_DUR = 1.0F;
    private AbstractCard card;
    private static final float PADDING;

    public ShowCardToDiscardEffect(AbstractCard srcCard, float x, float y) {
        this.card = srcCard;
    ...
    public ShowCardToDiscardEffect(AbstractCard card) {
        this.card = card;
        this.duration = EFFECT_DUR;
    ...
    private void identifySpawnLocation(float x, float y) {
        ...
        while(var4.hasNext()) {
            ...
            if (e instanceof com.megacrit.cardcrawl.vfx.cardManip.ShowCardAndAddToDiscardEffect) {
                ++effectCount;
            }
        }
