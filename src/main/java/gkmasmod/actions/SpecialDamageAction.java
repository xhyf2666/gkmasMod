...
public class SpecialDamageAction extends AbstractGameAction {
    private DamageInfo info;
    private AbstractCard card;
    private AbstractCreature owner;
    private boolean countTime = false;

    public SpecialDamageAction(AbstractCreature target, DamageInfo info, AttackEffect effect) {
        this(target, info, effect, null);
    }

    public SpecialDamageAction(AbstractCreature target, DamageInfo info, AttackEffect effect, AbstractCard card) {
        this(target, info, effect, card, false);
    }

    public SpecialDamageAction(AbstractCreature target, DamageInfo info, AttackEffect effect, AbstractCard card, boolean countTime) {
        this.target = target;
        this.info = info;
    ...
    public int calculateDamage(int baseDamage, AbstractCreature m){
        ...
        if (m != null) {
            ...
            for(var9 = m.powers.iterator(); var9.hasNext(); ) {
                p = (AbstractPower)var9.next();
