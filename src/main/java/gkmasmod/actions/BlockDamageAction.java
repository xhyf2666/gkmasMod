...
public class BlockDamageAction extends AbstractGameAction {
    ...
    public BlockDamageAction(float rate, int blockAdd, AbstractPlayer p, AbstractMonster m, AbstractCard card) {
        this(rate, blockAdd, p, m,card, false);
    }

    public BlockDamageAction(float rate, int blockAdd, AbstractPlayer p, AbstractMonster m, AbstractCard card,boolean damageAll) {
        this(rate, blockAdd, p, m,card,damageAll,1.0f);
    }

    public BlockDamageAction(float rate, int blockAdd, AbstractPlayer p, AbstractMonster m, AbstractCard card,boolean damageAll,float yarukiRate) {
        this.m = m;
        this.p = p;
