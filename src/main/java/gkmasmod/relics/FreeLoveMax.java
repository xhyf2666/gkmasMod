...
public class FreeLoveMax extends CustomRelic {

    private static final String CLASSNAME = FreeLoveMax.class.getSimpleName();
    ...
    public void atTurnStart() {
        if (this.counter > 0) {
            ...
            if(count>YARUKI){
                ...
                this.flash();
                addToBot(new GainBlockWithPowerAction(AbstractDungeon.player,this.magicNumber));
                this.counter--;
                if (this.counter == 0) {
                    this.grayscale = true;
                }
