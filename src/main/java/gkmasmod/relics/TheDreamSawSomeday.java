...
public class TheDreamSawSomeday extends CustomRelic {
    ...
    private static final String CLASSNAME = TheDreamSawSomeday.class.getSimpleName();
    ...
    public void onUseCard(AbstractCard card, UseCardAction useCardAction){
        if (card.cardID.equals(WarmUp.ID)) {
            if (this.counter > 0) {
                ...
                addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new TheDreamSawSomedayPower(AbstractDungeon.player, this.magicNumber2), this.magicNumber2));
                this.counter--;
                if (this.counter == 0) {
                    this.grayscale = true;
                }
