...
public class DreamOfTheDescription extends CustomRelic {

    private static final String CLASSNAME = DreamOfTheDescription.class.getSimpleName();
    ...
    public AbstractRelic makeCopy() {
        return new DreamOfTheDescription();
    }
    ...
    public void onUseCard(AbstractCard card, UseCardAction useCardAction){
        if (card.cardID.equals(TeaChat.ID)) {
            if (this.counter > 0) {
