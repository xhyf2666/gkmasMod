...
public class LastSummerMemory extends CustomRelic {

    private static final String CLASSNAME = LastSummerMemory.class.getSimpleName();
    ...
    public AbstractRelic makeCopy() {
        return (AbstractRelic)new LastSummerMemory();
    }
