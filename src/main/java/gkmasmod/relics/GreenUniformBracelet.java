...
public class GreenUniformBracelet extends CustomRelic {

    private static final String CLASSNAME = GreenUniformBracelet.class.getSimpleName();
    ...
    public AbstractRelic makeCopy() {
        return new GreenUniformBracelet();
    }
