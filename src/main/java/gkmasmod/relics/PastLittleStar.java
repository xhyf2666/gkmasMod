...
public class PastLittleStar extends CustomRelic {

    private static final String CLASSNAME = PastLittleStar.class.getSimpleName();
    ...
    public void onUseCard(AbstractCard card, UseCardAction useCardAction){
        if (card.cardID.equals(ServiceSpirit.ID)) {
            if (this.counter > 0) {
                ...
                addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new AnotherTurnPower(AbstractDungeon.player, magicNumber2), magicNumber2));
                this.counter--;
                if (this.counter == 0) {
                    this.grayscale = true;
                }
