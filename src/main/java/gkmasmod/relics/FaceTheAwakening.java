...
public class FaceTheAwakening extends CustomRelic {
    ...
    private static final String CLASSNAME = FaceTheAwakening.class.getSimpleName();
    ...
    public void onUseCard(AbstractCard card, UseCardAction useCardAction){
        if (card.cardID.equals(LightGait.ID)) {
            if (this.counter > 0) {
