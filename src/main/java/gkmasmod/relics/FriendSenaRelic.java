...
import gkmasmod.monster.friend.FriendSena;

public class FriendSenaRelic extends CustomRelic {

    private static final String CLASSNAME = FriendSenaRelic.class.getSimpleName();
