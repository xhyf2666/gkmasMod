...
public class WishFulfillmentAmulet extends CustomRelic {

    private static final String CLASSNAME = WishFulfillmentAmulet.class.getSimpleName();
    ...
    public AbstractRelic makeCopy() {
        return new WishFulfillmentAmulet();
    }
