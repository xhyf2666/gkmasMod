...
public class OnlyMyFirstStar extends CustomRelic {

    private static final String CLASSNAME = OnlyMyFirstStar.class.getSimpleName();
    ...
    public void onUseCard(AbstractCard card, UseCardAction useCardAction){
        if (card.cardID.equals(Smile.ID)) {
            if (this.counter > 0) {
