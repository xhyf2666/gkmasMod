...
public class PinkUniformBracelet extends CustomRelic {

    private static final String CLASSNAME = PinkUniformBracelet.class.getSimpleName();
    ...
    public AbstractRelic makeCopy() {
        return new PinkUniformBracelet();
    }
