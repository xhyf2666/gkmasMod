...
public class FoodTonkatsuSP extends CustomRelic {
    ...
    private static final String CLASSNAME = FoodTonkatsuSP.class.getSimpleName();
    ...
    public void onEquip() {
        ...
        AbstractDungeon.actionManager.addToBottom(new FullPowerValueAction(AbstractDungeon.player,true));
    }
