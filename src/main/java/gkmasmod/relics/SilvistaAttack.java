...
public class SilvistaAttack extends CustomRelic {
    ...
    private static final String CLASSNAME = SilvistaAttack.class.getSimpleName();
    ...
    private static final int magicNumber3 = 70;

    private static final int TURN = 2;

    public SilvistaAttack() {
        super(ID, ImageMaster.loadImage(IMG), ImageMaster.loadImage(IMG_OTL), RARITY, LandingSound.CLINK);
    }

    @Override
    public String getUpdatedDescription() {
        return String.format(this.DESCRIPTIONS[0],TURN,magicNumber,magicNumber2,magicNumber3);
    }

    @Override
    public AbstractRelic makeCopy() {
        return new SilvistaAttack();
    }
    ...
    public void onPlayerEndTurn() {
        ...
        if (this.counter == 0) {
            int count = AbstractDungeon.player.exhaustPile.size();
