...
public class IdolData {
    ...
    static {
        idols.put(shro, new Idol(shro,
                ...
                new String[]{"skin10","skin11","skin12","skin14","skin13","skin15","skin16","skin17"},
                ...
                new String[]{"no","no","no","3_000","3_001","3_003","3_004","3_006"},
                66,99,new int[]{115,115,80},new float[]{0.27f,0.23f,0.10f},
                new int[]{1200,1000,800},
                new int[]{0,1,0},new int[]{300,450,1000},
                new int[]{9,11,13},
                new String[]{"1_000","1_001","2_000","3_000","3_001","3_003","3_004","3_006"},
        ...
        idols.put(kllj, new Idol(kllj,
                ...
                new String[]{"skin10","skin11","skin12","skin14","skin13","skin15","skin17"},
        ...
        idols.put(kcna, new Idol(kcna,
                ...
                new String[]{"skin10","skin11","skin12","skin14","skin13","skin15","skin16","skin13","skin11","skin17"},
        ...
        idols.put(hume, new Idol(hume,
                ...
                new String[]{"skin10","skin11","skin12","skin13","skin10","skin16","skin17"},
        ...
        idols.put(hski, new Idol(hski,
                new String[]{"skin10","skin11","skin20","skin30","skin31","skin33","skin34","skin36","skin37"},
                new String[]{"skin10","skin11","skin12","skin14","skin13","skin15","skin16","skin11","skin17"},
                new String[]{RisingStar.ID, FirstFuture.ID, NeverYieldFirst.ID, NeverLose.ID, Pow.ID, NeverLose.ID, GoldfishScoopingChallenge.ID,NeverLose.ID,VeryEasy.ID},
                new String[]{RoaringLion.ID,FirstVoiceProofSaki.ID,SakiCompleteMealRecipe.ID,TogetherInBattleTowel.ID,WinningDetermination.ID,TogetherInBattleTowel.ID,UndefeatedPoi.ID,TogetherInBattleTowel.ID,AnimateEquipment.ID},
                new IdolType[]{IdolType.SENSE,IdolType.LOGIC,IdolType.SENSE,IdolType.SENSE,IdolType.LOGIC,IdolType.SENSE,IdolType.LOGIC,IdolType.SENSE,IdolType.SENSE},
                new IdolStyle[]{IdolStyle.GOOD_TUNE,IdolStyle.GOOD_IMPRESSION,IdolStyle.GOOD_TUNE,IdolStyle.GOOD_TUNE,IdolStyle.GOOD_IMPRESSION,IdolStyle.GOOD_TUNE,IdolStyle.GOOD_IMPRESSION,IdolStyle.GOOD_TUNE,IdolStyle.FOCUS},
                ...
                new String[]{"all_001","all_001","all_001","hski_001","hski_002","all_003","all_004","all_005","all_006"},
                new String[]{"no","no","no","3_000","3_001","3_003","no","3_006","3_007"},
                76,99,new int[]{100,100,105},new float[]{0.18f,0.18f,0.20f},
                new int[]{800,1000,1200},
                new int[]{1,0,2},new int[]{200,450,900},
                new int[]{10,13,12},
                new String[]{"1_000","1_001","2_000","3_000","3_001","3_003","3_004","3_006","3_007"},
                new String[]{"002","003","007"},
        ...
        idols.put(fktn, new Idol(fktn,
                ...
                new String[]{"skin10","skin11","skin12","skin14","skin13","skin15","skin16","skin13","skin17"},
        ...
        idols.put(ssmk, new Idol(ssmk,
                ...
                new String[]{"skin10","skin11","skin12","skin14","skin13","skin15","skin16","skin17"},
                new String[]{Friendly.ID,FirstMiss.ID, BraveStep.ID, OneMoreStep.ID, AfternoonBreeze.ID, OneMoreStep.ID, OneMoreStep.ID, OneMoreStep.ID},
                new String[]{PinkUniformBracelet.ID,FirstLoveProofSumika.ID, AfterSchoolDoodles.ID, ArcadeLoot.ID, FrogFan.ID, ArcadeLoot.ID, ArcadeLoot.ID, ArcadeLoot.ID},
                ...
                new IdolStyle[]{IdolStyle.FOCUS,IdolStyle.YARUKI,IdolStyle.FOCUS,IdolStyle.FOCUS,IdolStyle.YARUKI,IdolStyle.FOCUS,IdolStyle.FOCUS,IdolStyle.FOCUS},
                ...
                new String[]{"1","1","1","1","2","2","2","3","3","3"},
                new String[]{"1","1","1","2","4","5","6"},
                new String[]{"all_001","all_001","all_001","ssmk_001","all_003","all_004","all_005","all_007"},
        ...
        idols.put(jsna, new Idol(jsna,
                ...
                new String[]{"002","002","002"},//bossSongs,
                new String[]{ListenToMyTrueHeart.ID, CallMeAnyTime.ID},
                new String[]{"skin10","skin12","skin17"}
        ));
