...
public class EndOfTurnPreservationStancePlusPower extends AbstractPower {
    private static final String CLASSNAME = EndOfTurnPreservationStancePlusPower.class.getSimpleName();
    ...
    public EndOfTurnPreservationStancePlusPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
