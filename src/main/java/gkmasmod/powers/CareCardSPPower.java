...
public class CareCardSPPower extends AbstractPower {
    private static final String CLASSNAME = CareCardSPPower.class.getSimpleName();
    ...
    public CareCardSPPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
