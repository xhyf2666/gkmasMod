...
public class AllEffort extends AbstractPower {
    private static final String CLASSNAME = AllEffort.class.getSimpleName();
    ...
    public AllEffort(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
