...
public class SelfEsteemBoostPower extends AbstractPower {
    private static final String CLASSNAME = SelfEsteemBoostPower.class.getSimpleName();
    ...
    public SelfEsteemBoostPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
