...
public class EnthusiasticAddRatePower extends AbstractIncreaseModifyPower {
    private static final String CLASSNAME = EnthusiasticAddRatePower.class.getSimpleName();
    ...
    public EnthusiasticAddRatePower(AbstractCreature owner, int amount) {
        this(owner, amount, RATE, null);
    }

    public EnthusiasticAddRatePower(AbstractCreature owner, int amount, int rate) {
        this(owner, amount, rate, null);
    }

    public EnthusiasticAddRatePower(AbstractCreature owner, int amount, int rate, String source){
