...
public class GoodImpressionAddRatePower extends AbstractIncreaseModifyPower {
    private static final String CLASSNAME = GoodImpressionAddRatePower.class.getSimpleName();
    ...
    public GoodImpressionAddRatePower(AbstractCreature owner, int amount) {
        this(owner, amount, RATE, null);
    }

    public GoodImpressionAddRatePower(AbstractCreature owner, int amount, int rate) {
        this(owner, amount, rate, null);
    }

    public GoodImpressionAddRatePower(AbstractCreature owner, int amount, int rate, String source){
