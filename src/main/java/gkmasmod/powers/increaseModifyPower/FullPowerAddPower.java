...
public class FullPowerAddPower extends AbstractIncreaseModifyPower {
    private static final String CLASSNAME = FullPowerAddPower.class.getSimpleName();
    ...
    public FullPowerAddPower(AbstractCreature owner, int amount) {
