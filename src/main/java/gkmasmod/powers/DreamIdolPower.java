...
public class DreamIdolPower extends AbstractPower {
    private static final String CLASSNAME = DreamIdolPower.class.getSimpleName();
    ...
    private static final float rate = 0.30F;
    ...
    public DreamIdolPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void onGainedBlock(float blockAmount) {
        ...
        for(int i = 0; i < this.amount; i++) {
            ...
            damageInfo.name = TopWisdomPower.POWER_ID;
