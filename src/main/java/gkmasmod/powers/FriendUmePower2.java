...
public class FriendUmePower2 extends AbstractPower {
    private static final String CLASSNAME = FriendUmePower2.class.getSimpleName();
    ...
    public FriendUmePower2(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void atStartOfTurn() {
        this.flash();
        int damage = (int) (AbstractDungeon.player.maxHealth * 1.0F * MAGIC / 100);
