...
public class SenseOfDistancePower extends AbstractPower {
    private static final String CLASSNAME = SenseOfDistancePower.class.getSimpleName();
    ...
    public SenseOfDistancePower(AbstractCreature owner,int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
