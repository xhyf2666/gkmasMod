...
import gkmasmod.downfall.cards.logic.ENSSDSecret;
import gkmasmod.utils.NameHelper;

public class MotherAIPower extends AbstractPower {
    private static final String CLASSNAME = MotherAIPower.class.getSimpleName();
    // 能力的ID
    ...
    public MotherAIPower(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
