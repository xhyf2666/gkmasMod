...
public class SenseOfAccomplishmentSPPower extends AbstractPower {
    private static final String CLASSNAME = SenseOfAccomplishmentSPPower.class.getSimpleName();
    ...
    public SenseOfAccomplishmentSPPower(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
