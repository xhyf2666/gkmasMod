...
public class TrainRoundSensePower extends AbstractPower {
    ...
    public void reducePower(int reduceAmount) {
        System.out.println("reducePower"+this.amount+" "+reduceAmount);
    ...
    public void stackPower(int stackAmount) {
        ...
        if (this.amount == 0){
            System.out.println("stackPower"+this.amount+" "+stackAmount);
            addToTop(new RemoveSpecificPowerAction(this.owner, this.owner, this.ID));
        }
    }

    public void updateDescription() {
        this.description = String.format(DESCRIPTIONS[0], this.amount,magicNumber);
    }
    ...
    public void onAttack(DamageInfo info, int damageAmount, AbstractCreature target) {
        int count = (int) (1.0F*damageAmount * magicNumber /100);
        addToBot(new GainBlockAction(AbstractDungeon.player, AbstractDungeon.player, count));
    }
