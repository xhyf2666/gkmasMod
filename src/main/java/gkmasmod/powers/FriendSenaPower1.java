...
public class FriendSenaPower1 extends AbstractPower {
    private static final String CLASSNAME = FriendSenaPower1.class.getSimpleName();
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if (card.type == AbstractCard.CardType.POWER) {
            this.addToTop(new ApplyPowerAction(this.owner, this.owner, new StrengthPower(this.owner, MAGIC), MAGIC));
            this.flash();
        }
    }
}
