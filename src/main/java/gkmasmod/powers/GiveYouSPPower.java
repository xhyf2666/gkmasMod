...
public class GiveYouSPPower extends AbstractPower {
    private static final String CLASSNAME = GiveYouSPPower.class.getSimpleName();
    ...
    public GiveYouSPPower(AbstractCreature owner) {
        this.name = NAME;
