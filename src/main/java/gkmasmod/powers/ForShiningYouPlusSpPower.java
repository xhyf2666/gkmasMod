...
import gkmasmod.actions.cardAction.ForShiningYouDamageAction;
...
public class ForShiningYouPlusSpPower extends AbstractPower {
    private static final String CLASSNAME = ForShiningYouPlusSpPower.class.getSimpleName();
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        ...
        for(int i = 0; i < this.amount; i++) {
            ...
            addToBot(new ApplyPowerAction(this.owner, this.owner, new GoodImpression(this.owner, 1), 1));
        }
