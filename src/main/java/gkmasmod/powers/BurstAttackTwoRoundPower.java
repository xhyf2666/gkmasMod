...
public class BurstAttackTwoRoundPower extends AbstractPower {
    private static final String CLASSNAME = BurstAttackTwoRoundPower.class.getSimpleName();
    ...
    public BurstAttackTwoRoundPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
