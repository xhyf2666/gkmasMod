...
public class TopWisdomPlusPower extends AbstractPower {
    private static final String CLASSNAME = TopWisdomPlusPower.class.getSimpleName();
    ...
    public TopWisdomPlusPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
