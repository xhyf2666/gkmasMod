...
public class SakiGoodTunePower extends AbstractPower {
    private static final String CLASSNAME = SakiGoodTunePower.class.getSimpleName();
    // 能力的ID
    ...
    public SakiGoodTunePower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
