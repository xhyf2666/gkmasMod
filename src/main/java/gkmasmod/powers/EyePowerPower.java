...
public class EyePowerPower extends AbstractPower {
    private static final String CLASSNAME = EyePowerPower.class.getSimpleName();
    ...
    public EyePowerPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
