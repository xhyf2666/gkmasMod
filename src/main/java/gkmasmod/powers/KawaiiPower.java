...
public class KawaiiPower extends AbstractPower {
    private static final String CLASSNAME = KawaiiPower.class.getSimpleName();
    ...
    public KawaiiPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
