...
public class ToTheTopPower extends AbstractPower {
    private static final String CLASSNAME = ToTheTopPower.class.getSimpleName();
    ...
    public ToTheTopPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
