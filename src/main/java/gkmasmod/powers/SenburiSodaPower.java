...
public class SenburiSodaPower extends AbstractPower {
    private static final String CLASSNAME = SenburiSodaPower.class.getSimpleName();
    // 能力的ID
    ...
    public SenburiSodaPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
    ...
    public float atDamageFinalGive(float damage, DamageInfo.DamageType type) {
        if (type == DamageInfo.DamageType.NORMAL) {
            ...
            for (AbstractPower p : this.owner.powers) {
                if (p instanceof SenburiSodaPower) {
                    count++;
                }
