...
public class WantToSleep extends AbstractPower {
    private static final String CLASSNAME = WantToSleep.class.getSimpleName();
    ...
    public WantToSleep(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
