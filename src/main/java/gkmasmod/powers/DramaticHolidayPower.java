...
public class DramaticHolidayPower extends AbstractPower {
    private static final String CLASSNAME = DramaticHolidayPower.class.getSimpleName();
    ...
    public DramaticHolidayPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        ...
        if(card.type == AbstractCard.CardType.ATTACK) {
            ...
            if(this.count<magic)
                return;
            this.count = 0;
            int dexterityAmount = PlayerHelper.getPowerAmount(this.owner, DexterityPower.POWER_ID);
            if(dexterityAmount>=magic2){
