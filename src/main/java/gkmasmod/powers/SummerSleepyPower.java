...
public class SummerSleepyPower extends AbstractPower {
    private static final String CLASSNAME = SummerSleepyPower.class.getSimpleName();
    ...
    public SummerSleepyPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
