...
public class FriendKotonePower2 extends AbstractPower {
    private static final String CLASSNAME = FriendKotonePower2.class.getSimpleName();
    ...
    String path128 = String.format("gkmasModResource/img/powers/%s_84.png","MyPrideBigSisterPower");
