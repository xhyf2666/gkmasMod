...
public class DaSpPower extends AbstractPower {
    ...
    public void onDeath() {
        if(!this.owner.isPlayer){
            ...
            AbstractDungeon.effectList.add(new GainThreeSizeSpEffect(new Random().nextInt(123456789),2,idol.getDa(),idol.getDa()+change_,this.owner.hb.cX, this.owner.hb.cY));
