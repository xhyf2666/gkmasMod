...
public class CareCardPower extends AbstractPower {
    private static final String CLASSNAME = CareCardPower.class.getSimpleName();
    ...
    public CareCardPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
