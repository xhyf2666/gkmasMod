...
public class ChangeScene extends AbstractGameEffect {
  ...
  public ChangeScene(Texture img) {
        ...
        this.img = img;
        this.img2 = ImageMaster.loadImage("gkmasModResource/img/vfx/Mask.png");
        this.img3 = ImageMaster.loadImage("gkmasModResource/img/vfx/Mask2.png");
