...
public class FriendChina extends CustomMonster {

    public static final String ID = "FriendChina";

    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings("gkmasMod:FriendChina");
    ...
    public FriendChina(float x, float y) {
        ...
        addToBot(new ApplyPowerAction(this,this,new FriendChinaPower1(this)));
        addToBot(new ApplyPowerAction(this,this,new FriendChinaPower2(this)));
        this.img = new Texture("gkmasModResource/img/monsters/other/FriendChina.png");
    }
