...
public class HajimeBoss extends CustomMonster {
    public static final String ID = "Hajime";

    private static final MonsterStrings monsterStrings = CardCrawlGame.languagePack.getMonsterStrings("gkmasMod:Hajime");
    ...
    private static int MAX_HEALTH = 1700;
    ...
    public HajimeBoss(float x, float y) {
        super(NAME, ID, MAX_HEALTH, -8.0F, 0.0F, 360.0F, 240.0F, null, x, y);
        this.img = new Texture("gkmasModResource/img/monsters/Hajime/Sensei.png");
...
//                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, new InvinciblePower(this, 9000), 9000));
    ...
    public void damage(DamageInfo info) {
        ...
        if(stage==2&&!this.isOutTriggered && this.currentHealth <= 15000) {
            CardCrawlGame.music.dispose();
            CardCrawlGame.music.playTempBgmInstantly(
