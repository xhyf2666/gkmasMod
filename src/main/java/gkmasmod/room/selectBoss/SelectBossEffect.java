...
import gkmasmod.event.SelectBossEvent;
import gkmasmod.event.SupplyEvent;
import gkmasmod.modcore.GkmasMod;

import java.util.ArrayList;

public class SelectBossEffect extends AbstractGameEffect {
...
//                            AbstractDungeon.eventList.add(0, eventID);
            AbstractEvent event =  EventUtils.getEvent(SelectBossEvent.ID);
            cer.event = event;
        } catch (Exception e) {
        }
