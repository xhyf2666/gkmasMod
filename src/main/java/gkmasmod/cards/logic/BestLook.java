...
public class BestLook extends GkmasCard {
    private static final String CLASSNAME = BestLook.class.getSimpleName();
    ...
    public BestLook() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(MagicCustom.growID, new int[]{2}, new int[]{80}, CustomHelper.CustomEffectType.DEXTERITY_ADD));
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p,p, new GoodImpression(p, this.secondMagicNumber)));
        SoundHelper.playSound("gkmasModResource/audio/voice/skillcard/cidol_ssmk_3_019_produce_skillcard_01.ogg");
    }
