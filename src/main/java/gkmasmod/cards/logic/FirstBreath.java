...
public class FirstBreath extends GkmasCard {
    private static final String CLASSNAME = FirstBreath.class.getSimpleName();
    ...
    public FirstBreath() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(BlockCustom.growID,new int[]{2,2},new int[]{50,50},CustomHelper.CustomEffectType.BLOCK_ADD));
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        SoundHelper.playSound("gkmasModResource/audio/voice/skillcard/cidol_hmsz_1_001_produce_skillcard_01.ogg");

    }

    @Override
    public AbstractCard makeCopy() {
        return new FirstBreath();
    }
