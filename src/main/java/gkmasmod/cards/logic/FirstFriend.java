...
public class FirstFriend extends GkmasCard {
    ...
    public FirstFriend() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(SecondMagicCustom.growID, new int[]{10,10}, new int[]{50,50}, CustomHelper.CustomEffectType.RATE_ADD));
