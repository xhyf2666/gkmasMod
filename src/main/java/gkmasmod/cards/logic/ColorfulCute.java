...
public class ColorfulCute extends GkmasCard {
    ...
    public ColorfulCute() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(MagicCustom.growID, new int[]{2,2}, new int[]{70,70}, CustomHelper.CustomEffectType.GOOD_IMPRESSION_ADD));
