...
import gkmasmod.powers.DreamIdolPower;
import gkmasmod.powers.NextTurnIdolBlockPower;
import gkmasmod.utils.*;

import java.util.ArrayList;

public class DreamIdol extends GkmasCard {
    private static final String CLASSNAME = DreamIdol.class.getSimpleName();
    ...
    private static final int BASE_MAGIC3 = 30;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        SoundHelper.playSound("gkmasModResource/audio/voice/skillcard/cidol_hmsz_3_010_produce_skillcard_01.ogg");

    }

    @Override
    public AbstractCard makeCopy() {
        return new DreamIdol();
    }
