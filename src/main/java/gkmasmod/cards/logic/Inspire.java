...
public class Inspire extends GkmasCard {
    ...
    public Inspire() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(ThirdMagicCustom.growID,new int[]{1,1,1},new int[]{50,50,80},CustomHelper.CustomEffectType.GOOD_IMPRESSION_ADD));
    }
