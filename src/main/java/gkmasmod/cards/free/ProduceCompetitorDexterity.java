...
public class ProduceCompetitorDexterity extends GkmasCard {
    private static final String CLASSNAME = ProduceCompetitorDexterity.class.getSimpleName();
    ...
    public ProduceCompetitorDexterity() {
    ...
    public AbstractCard makeCopy() {
        return new ProduceCompetitorDexterity();
    }
    ...
    public void onChoseThisOption() {
        ...
        for(AbstractMonster mo: AbstractDungeon.getMonsters().monsters){
            if(!mo.isDeadOrEscaped()&&!AbstractMonsterPatch.friendlyField.friendly.get(mo)){
                addToBot(new ApplyPowerAction(mo, AbstractDungeon.player, new DexterityPower(mo, this.magicNumber), this.magicNumber));
            }
        }
        addToBot(new MakeTempCardInHandAction(new LittleAmbition()));
    }
