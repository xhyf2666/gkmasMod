...
public class ProduceCompetitorStrength extends GkmasCard {
    private static final String CLASSNAME = ProduceCompetitorStrength.class.getSimpleName();
    ...
    public ProduceCompetitorStrength() {
    ...
    public AbstractCard makeCopy() {
        return new ProduceCompetitorStrength();
    }
    ...
    public void onChoseThisOption() {
        ...
        for(AbstractMonster mo: AbstractDungeon.getMonsters().monsters){
            if(!mo.isDeadOrEscaped()&&!AbstractMonsterPatch.friendlyField.friendly.get(mo)){
                addToBot(new ApplyPowerAction(mo, AbstractDungeon.player, new StrengthPower(mo, this.magicNumber), this.magicNumber));
            }
        }
        addToBot(new MakeTempCardInHandAction(new LittleAmbition()));
    }
