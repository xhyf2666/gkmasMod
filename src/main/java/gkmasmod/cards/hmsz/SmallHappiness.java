...
public class SmallHappiness extends GkmasCard {
    private static final String CLASSNAME = SmallHappiness.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        int count = PlayerHelper.getNegativePowerTotalAmount(m);
        count = count * this.magicNumber / 100;
        if(count > 0)
