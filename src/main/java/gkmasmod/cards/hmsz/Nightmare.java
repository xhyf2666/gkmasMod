...
public class Nightmare extends GkmasCard {
    private static final String CLASSNAME = Nightmare.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if(m.hasPower(WantToSleepEnemy.POWER_ID)|| PlayerHelper.getPowerAmount(m,WantToSleepEnemy.POWER_ID)>9){
            addToBot(new ApplyPowerAction(m,m,new VulnerablePower(m,this.magicNumber,true),this.magicNumber));
