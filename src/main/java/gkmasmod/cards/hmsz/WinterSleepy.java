...
public class WinterSleepy extends GkmasCard {
    private static final String CLASSNAME = WinterSleepy.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new WinterSleepyPower(p,1),1));
        if(this.upgraded){
