...
public class GoToDream extends GkmasCard {
    private static final String CLASSNAME = GoToDream.class.getSimpleName();
    ...
    private static final int BASE_MAGIC = 9;
