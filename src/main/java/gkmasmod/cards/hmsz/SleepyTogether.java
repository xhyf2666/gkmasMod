...
public class SleepyTogether extends GkmasCard {
    private static final String CLASSNAME = SleepyTogether.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for(AbstractMonster mo: AbstractDungeon.getMonsters().monsters){
            if(!mo.isDeadOrEscaped()&&!AbstractMonsterPatch.friendlyField.friendly.get(mo)){
                addToBot(new ApplyPowerAction(mo, p, new WantToSleepEnemy(mo, this.magicNumber), this.magicNumber));
            }
        }
    }
