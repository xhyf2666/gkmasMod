...
import gkmasmod.powers.EvilSourcePower;
import gkmasmod.utils.ImageHelper;
import gkmasmod.utils.NameHelper;

public class EvilSource extends GkmasCard {
    private static final String CLASSNAME = EvilSource.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p,p,new EvilSourcePower(p)));
    }

    @Override
    public AbstractCard makeCopy() {
        return new EvilSource();
    }
