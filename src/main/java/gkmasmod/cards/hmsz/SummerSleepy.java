...
public class SummerSleepy extends GkmasCard {
    private static final String CLASSNAME = SummerSleepy.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new SummerSleepyPower(p,this.magicNumber),this.magicNumber));
    }

    @Override
    public AbstractCard makeCopy() {
        return new SummerSleepy();
    }
