...
public class ConfusedThings extends GkmasCard {
    private static final String CLASSNAME = ConfusedThings.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        int count = PlayerHelper.getNegativePowerAmount(m);
        if(count>this.thirdMagicNumber){
            addToBot(new ApplyPowerAction(m, p, new WantToSleepEnemy(m, this.secondMagicNumber), this.secondMagicNumber));
        }
    }

    @Override
    public AbstractCard makeCopy() {
        return new ConfusedThings();
    }
