...
public class AutumnSleepy extends GkmasCard {
    private static final String CLASSNAME = AutumnSleepy.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new AutumnSleepyPower(p,this.magicNumber),this.magicNumber));
    }

    @Override
    public AbstractCard makeCopy() {
        return new AutumnSleepy();
    }
