...
public class SleeplessNight extends GkmasCard {
    private static final String CLASSNAME = SleeplessNight.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new SleeplessNightPower(p)));
    }

    @Override
    public AbstractCard makeCopy() {
        return new SleeplessNight();
    }
