...
public class GkmasCardTag {
    @SpireEnum public static AbstractCard.CardTags GOOD_TUNE_TAG;
    @SpireEnum public static AbstractCard.CardTags FOCUS_TAG;
    @SpireEnum public static AbstractCard.CardTags GOOD_IMPRESSION_TAG;
