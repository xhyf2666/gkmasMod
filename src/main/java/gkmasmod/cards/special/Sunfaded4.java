...
public class Sunfaded4 extends GkmasCard {
    private static final String CLASSNAME = Sunfaded4.class.getSimpleName();
    ...
    public Sunfaded4() {
        ...
        updateBackgroundImg();
        this.cardsToPreview = new Sunfaded4_sp();
    }
