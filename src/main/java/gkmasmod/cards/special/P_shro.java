...
public class P_shro extends GkmasCard {
    private static final String CLASSNAME = P_shro.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        ArrayList<AbstractCard> cards = CardHelper.getAllIdolCards(colorList,"",IdolData.shro);
