...
public class P_hrnm extends GkmasCard {
    private static final String CLASSNAME = P_hrnm.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        ArrayList<AbstractCard> cards = CardHelper.getAllIdolCards(colorList,"",IdolData.hrnm);
