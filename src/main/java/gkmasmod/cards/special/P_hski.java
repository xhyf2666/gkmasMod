...
public class P_hski extends GkmasCard {
    private static final String CLASSNAME = P_hski.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        ArrayList<AbstractCard> cards = CardHelper.getAllIdolCards(colorList,"",IdolData.hski);
