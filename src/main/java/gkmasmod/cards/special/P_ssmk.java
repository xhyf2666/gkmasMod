...
import gkmasmod.cards.sense.EncounterWithHero;
...
public class P_ssmk extends GkmasCard {
    private static final String CLASSNAME = P_ssmk.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        ArrayList<AbstractCard> cards = CardHelper.getAllIdolCards(colorList,"",IdolData.ssmk);
