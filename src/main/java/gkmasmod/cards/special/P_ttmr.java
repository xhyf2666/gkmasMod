...
public class P_ttmr extends GkmasCard {
    private static final String CLASSNAME = P_ttmr.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        ArrayList<AbstractCard> cards = CardHelper.getAllIdolCards(colorList,"",IdolData.ttmr);
