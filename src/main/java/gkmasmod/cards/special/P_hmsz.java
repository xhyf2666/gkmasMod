...
public class P_hmsz extends GkmasCard {
    private static final String CLASSNAME = P_hmsz.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        ArrayList<AbstractCard> cards = CardHelper.getAllIdolCards(colorList,"",IdolData.hmsz);
