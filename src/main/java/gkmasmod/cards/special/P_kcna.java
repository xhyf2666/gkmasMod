...
public class P_kcna extends GkmasCard {
    private static final String CLASSNAME = P_kcna.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        ArrayList<AbstractCard> cards = CardHelper.getAllIdolCards(colorList,"",IdolData.kcna);
