...
public class P_kllj extends GkmasCard {
    private static final String CLASSNAME = P_kllj.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        ArrayList<AbstractCard> cards = CardHelper.getAllIdolCards(colorList,"",IdolData.kllj);
