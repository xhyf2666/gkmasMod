...
public class SelectLogic extends GkmasCard {
    private static final String CLASSNAME = SelectLogic.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player,
                new TrainRoundLogicPower(AbstractDungeon.player, count).updateMagic(turn-1), count));
    }
