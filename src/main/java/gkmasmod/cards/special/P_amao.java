...
public class P_amao extends GkmasCard {
    private static final String CLASSNAME = P_amao.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        ArrayList<AbstractCard> cards = CardHelper.getAllIdolCards(colorList,"",IdolData.amao);
