...
public class WalkAndWin extends GkmasCard {
    private static final String CLASSNAME = WalkAndWin.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new SelectCardGrowAction(1, TempOutAutoPlayGrow.growID,this.magicNumber,CustomHelper.hasCustom(this, EffectAddCustom.growID)));
    }

    @Override
    public AbstractCard makeCopy() {
        return new WalkAndWin();
    }
