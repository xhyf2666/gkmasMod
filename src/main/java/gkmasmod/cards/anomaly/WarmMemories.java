...
public class WarmMemories extends GkmasCard {
    ...
    public WarmMemories() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(SecondMagicCustom.growID, new int[]{1}, new int[]{70}, CustomHelper.CustomEffectType.TEMP_SAVE_ADD));
    }
