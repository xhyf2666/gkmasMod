...
public class NewLight extends GkmasCard {
    private static final String CLASSNAME = NewLight.class.getSimpleName();
    ...
    public NewLight() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(MagicCustom.growID,new int[]{1},new int[]{60},CustomHelper.CustomEffectType.ENTHUSIASTIC_ADD));
