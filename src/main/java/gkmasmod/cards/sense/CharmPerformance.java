...
public class CharmPerformance extends AbstractDefaultCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p,p,new CharmPerformancePower(p,this.baseDamage),this.baseDamage));
    }
