...
public class FirstGodArrival extends GkmasCard {
    private static final String CLASSNAME = FirstGodArrival.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        SoundHelper.playSound("gkmasModResource/audio/voice/skillcard/cidol_hume_1_001_produce_skillcard_01.ogg");
    }

    @Override
    public AbstractCard makeCopy() {
        return new FirstGodArrival();
    }
