...
import gkmasmod.powers.UntilHopeReachPower;
import gkmasmod.utils.*;

import java.util.ArrayList;

public class UntilHopeReach extends GkmasCard {
    private static final String CLASSNAME = UntilHopeReach.class.getSimpleName();
    ...
    public UntilHopeReach() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(MagicCustom.growID, new int[]{1}, new int[]{70}, CustomHelper.CustomEffectType.GOOD_TUNE_ADD));
