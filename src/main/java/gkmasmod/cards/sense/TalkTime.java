...
public class TalkTime extends GkmasCard {
    ...
    public TalkTime() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(MagicCustom.growID,new int[]{1},new int[]{50},CustomHelper.CustomEffectType.NOT_GOOD_TUNE_ADD));
