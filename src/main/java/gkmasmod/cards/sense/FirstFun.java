...
public class FirstFun extends GkmasCard {
    private static final String CLASSNAME = FirstFun.class.getSimpleName();
    ...
    public FirstFun() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(DamageCustom.growID, new int[]{2,2,2}, new int[]{40,40,40}, CustomHelper.CustomEffectType.DAMAGE_ADD));
