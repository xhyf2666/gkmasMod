...
public class ServiceSpirit extends AbstractDefaultCard {
    private static final String CLASSNAME = ServiceSpirit.class.getSimpleName();
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new ServiceSpirit();
    }
