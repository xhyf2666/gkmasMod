...
public class SecretMeeting extends GkmasCard {
    private static final String CLASSNAME = SecretMeeting.class.getSimpleName();
    ...
    public SecretMeeting() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(SecondMagicCustom.growID,new int[]{1},new int[]{50},CustomHelper.CustomEffectType.NOT_GOOD_TUNE_ADD));
