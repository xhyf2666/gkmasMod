...
public class Grip extends GkmasCard {
    private static final String CLASSNAME = Grip.class.getSimpleName();
    ...
    public Grip() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(NotGoodTuneCustom.growID,new int[]{2},new int[]{80},CustomHelper.CustomEffectType.NOT_GOOD_TUNE_ADD));
    }
