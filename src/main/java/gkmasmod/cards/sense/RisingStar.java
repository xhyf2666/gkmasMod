...
public class RisingStar extends GkmasCard {
    ...
    public RisingStar() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(DamageCustom.growID, new int[]{3,3,3}, new int[]{50,50,50}, CustomHelper.CustomEffectType.DAMAGE_ADD));
