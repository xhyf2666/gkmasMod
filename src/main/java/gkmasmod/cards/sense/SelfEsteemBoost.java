...
import gkmasmod.powers.SelfEsteemBoostPower;
...
public class SelfEsteemBoost extends GkmasCard {
    private static final String CLASSNAME = SelfEsteemBoost.class.getSimpleName();
    ...
    public SelfEsteemBoost() {
        ...
        this.customEffectList.add(CustomHelper.generateCustomEffectList(DrawCardCustom.growID,new int[]{1},new int[]{50},CustomHelper.CustomEffectType.DRAW_CARD_ADD));
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p,p,new SelfEsteemBoostPower(p,this.secondMagicNumber),this.secondMagicNumber));
        SoundHelper.playSound("gkmasModResource/audio/voice/skillcard/cidol_fktn_3_002_produce_skillcard_01.ogg");
    }

    @Override
    public AbstractCard makeCopy() {
        return new SelfEsteemBoost();
    }
