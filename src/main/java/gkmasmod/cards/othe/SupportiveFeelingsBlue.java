...
public class SupportiveFeelingsBlue extends GkmasCard {
    private static final String CLASSNAME = SupportiveFeelingsBlue.class.getSimpleName();
    ...
    public AbstractCard makeCopy() {
        return new SupportiveFeelingsBlue();
    }
