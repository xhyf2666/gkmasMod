...
public class IDontRemember extends GkmasCard {
    private static final String CLASSNAME = IDontRemember.class.getSimpleName();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new IDontRememberAction(p));
    }

    @Override
    public AbstractCard makeCopy() {
        return new IDontRemember();
    }
