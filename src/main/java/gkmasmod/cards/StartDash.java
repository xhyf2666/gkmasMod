...
public class StartDash extends AbstractDefaultCard implements CardImgUpdateListener {
    ...
    private static final String IMG_PATH = String.format("img/idol/cards/%s/%s.png", IdolCharacter.idolName, CLASSNAME);
