...
public class Plan_hrnm3 extends AbstractImageEvent {
    public static final String ID = Plan_hrnm3.class.getSimpleName();
    ...
    public Plan_hrnm3() {
        super(NAME, String.format(DESCRIPTIONS[0],CardCrawlGame.playerName), "gkmasModResource/img/event/teacherVi.png");
